...
public class Main {
	public static void main(String[] args) {
		...
		System.setProperty("empire.configuration.file", "empire.config.properties");
		...
		EntityManager aManager = Persistence.createEntityManagerFactory("books")
				.createEntityManager();

		// this retrieves a particular book from the database
		Book aBook = aManager.find(Book.class, URI.create("urn:x-domain:oreilly.com:product:9780596516499.IP"));
